...
\<bean id=*"configBean"*
class=*"com.boraji.tutorial.spring.xml.DatabaseConfig"*\>
...
###### <br>What is View Resolver pattern? how it works in Spring MVC
...
public SnapshotSearchStoredProcedure(DataSource dataSource, String
procedureName)
