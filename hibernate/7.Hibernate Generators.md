...
user will take care about generating Primary key value. But, hibernate can also
...
-   while inserting a new record in a database, **hibernate gets next value from
    the sequence** under assigns that value for the new record
...
**Output**
![E:\\Users\\kaveti_s.ITLINFOSYS\\Pictures\\12.png](media/5c16b6b593ed0fb1d40e9c9543864eab.png)
